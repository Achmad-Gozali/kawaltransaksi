...
export default function Footer() {
  return (
    <div style={{ backgroundColor: FOOTER_BG }}>
      ...
      {/* ── ATAP FOOTER (Wave Solid transisi dari putih ke gelap) ── */}
      {/* sengaja ditaruh full width (-mt-1 buat nutup celah piksel putih) */}
      <svg
        viewBox="0 0 1440 60"
        preserveAspectRatio="none"
        className="w-full block -mt-1 bg-transparent"
      ...
      >
        <path
          ...
          fill={FOOTER_BG}
        />
        {/* background pembungkus svg diatur lewat elemen pemanggil (biasanya body/bg-slate-50) */}
      </svg>
