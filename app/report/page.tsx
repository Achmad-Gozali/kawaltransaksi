...
export default async function ReportPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-emerald-100 selection:text-emerald-900 font-sans overflow-hidden">
      ...
      >
        <path
          d="M0,40 C320,-20 800,80 1440,20 L1440,80 L0,80 Z"
          fill="#f8fafc"
        />
      </svg>
      ...
      <section className="py-24 px-6 max-w-4xl mx-auto">
        ...
        {/* Circle + connector row (hide di mobile, muncul di md ke atas) */}
        ...
        {/* Cards row (tanpa kotak/card, full clean) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 pt-4">
          {steps.map((item, i) => (
            ...
            >
              {/* badge angka khusus mobile biar urutan tetep jelas */}
              ...
              {/* icon dibikin bulet soft biar nyatu sama tema */}
      ...
      <section className="pb-24 px-6 max-w-5xl mx-auto">
        <div className="bg-slate-900 border border-slate-800 rounded-md p-12 sm:p-20 text-center relative overflow-hidden shadow-xl">
