...
import { ArrowLeft, Building2, ShieldCheck, Clock, CheckCircle2, ArrowUpRight } from 'lucide-react';
import type { Metadata } from 'next';
import RekeningSearchForm from '@/components/RekeningSearchForm';
import { formatDateID } from '@/lib/utils';

export const metadata: Metadata = {
  title: 'Cek Rekening Bank - CekNoScam',
    ...
    <div className="min-h-screen bg-zinc-50">
      ...
      <div className="bg-white border-b border-zinc-100">
        <div className="max-w-5xl mx-auto px-4 py-16 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-50 text-emerald-600 text-[11px] font-bold uppercase tracking-widest mb-6">
          ...
          <div className="mt-10 flex justify-center gap-10">
            <div className="text-center">
              <p className="text-2xl font-extrabold text-zinc-900">{totalRekening || 0}</p>
              <p className="text-xs text-zinc-400 font-medium mt-1 uppercase tracking-wider">Rekening Dilaporkan</p>
            </div>
            <div className="w-px bg-zinc-200" />
            <div className="text-center">
              <p className="text-2xl font-extrabold text-red-600">{verifiedRekening || 0}</p>
      ...
      {reports.length > 0 && (
        <div className="max-w-5xl mx-auto px-4 py-14">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-sm font-extrabold text-zinc-900 uppercase tracking-wider">Rekening Terbaru Dilaporkan</h2>
            ...
            {reports.map((report: any) => (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  ...
                  {/* ✅ Pakai formatDateID dari utils — deterministik */}
      ...
      {reports.length === 0 && (
        <div className="max-w-5xl mx-auto px-4 py-14 text-center">
          ...
          <p className="text-sm text-zinc-400 max-w-sm mx-auto">Database rekening masih bersih. Bantu komunitas dengan melaporkan rekening penipu.</p>
        </div>
      )}
      ...
      <div className="max-w-5xl mx-auto px-4 pb-16">
        <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-extrabold text-emerald-900 uppercase tracking-wider">Tips Aman Transfer Bank</h3>
          </div>
