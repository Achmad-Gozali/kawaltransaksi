...
// ✅ FIX:
//    1. Branding konsisten: KawalTransaksi (bukan CekNoScam)
...
export const metadata: Metadata = {
  ...
  description:
    'Cek nomor HP atau WhatsApp terindikasi penipuan secara gratis.',
};
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {reports.map((report) => (
              ...
              >
                ...
                {/* ✅ FIX: Pakai maskNumber dari lib/utils.ts */}
      ...
      <div className="max-w-5xl mx-auto px-4 pb-12 sm:pb-16">
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 sm:p-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-xs sm:text-sm font-extrabold text-blue-900 uppercase tracking-wider">
              Tips Keamanan Nomor HP
            </h3>
          </div>
