...
export default function Footer() {
  return (
    <div style={{ backgroundColor: FOOTER_BG }}>
      <svg viewBox="0 0 1440 60" preserveAspectRatio="none" className="w-full block -mt-1" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col-span-2 md:col-span-2">
            ...
            <div className="flex md:flex-col gap-3">
              ...
              <a href="https://www.instagram.com/achmadgozali27_/" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2.5 text-xs font-bold text-slate-300 hover:text-white transition-colors">
                <span className="w-8 h-8 border border-slate-600 rounded-lg flex items-center justify-center hover:border-slate-400 transition-colors shrink-0">
                  <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="#cbd5e1" strokeWidth="2">
