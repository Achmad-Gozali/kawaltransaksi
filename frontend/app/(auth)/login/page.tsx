          ...
          {isBanned && (
            <div className="mb-5 p-3.5 bg-red-50 border border-red-200 rounded-xl flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-red-600">Akun Anda telah dinonaktifkan. Hubungi tim KawalTransaksi.</p>
              </div>
            </div>
          )}
          ...
          {isIdle && (
            <div className="mb-5 p-3.5 bg-amber-50 border border-amber-200 rounded-xl flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-amber-600">Sesi Anda berakhir karena tidak aktif.</p>
              </div>
            </div>
          )}
