    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center px-4 py-8">
      <div className="w-full max-w-xl text-center">
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap mb-6">
          <a href="/maintenance" className="flex items-center gap-2 px-7 py-3.5 bg-emerald-700 text-white text-sm sm:text-base font-bold rounded-xl hover:bg-emerald-800 transition-colors">
            <RefreshCw className="w-4 h-4" />Refresh Halaman
          </a>
          <a href="https://wa.me/6282249244647?text=Halo%20KawalTransaksi%2C%20saya%20ingin%20menanyakan%20estimasi%20selesainya%20maintenance%20website.%20Terima%20kasih." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-7 py-3.5 border-2 border-emerald-700 text-emerald-700 text-sm sm:text-base font-bold rounded-xl hover:bg-emerald-50 transition-colors">
