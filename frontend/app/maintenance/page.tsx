      ...
      <div className="max-w-xl w-full text-center space-y-8">
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          ...
          <a
            ...
            className="flex items-center gap-2 px-8 py-3.5 border-2 border-emerald-700 text-emerald-700 text-sm font-bold rounded-xl hover:bg-emerald-50 transition-colors"
          >
