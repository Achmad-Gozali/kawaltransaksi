    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center px-4 py-8">
      <div className="w-full max-w-lg text-center space-y-5">
        ...
        <div className="flex justify-center">
          <Image src="/maintenance.png" alt="Sedang Maintenance" width={400} height={400} className="w-64 sm:w-80 md:w-96 object-contain" priority />
        </div>
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          <a href="/maintenance" className="flex items-center gap-2 px-6 sm:px-8 py-3 bg-emerald-700 text-white text-sm sm:text-base font-bold rounded-xl hover:bg-emerald-800 transition-colors"><RefreshCw className="w-4 h-4" />Refresh Halaman</a>
          <a href="https://wa.me/6282249244647?text=Halo%20KawalTransaksi%2C%20saya%20ingin%20menanyakan%20estimasi%20selesainya%20maintenance%20website.%20Terima%20kasih." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 sm:px-8 py-3 border-2 border-emerald-700 text-emerald-700 text-sm sm:text-base font-bold rounded-xl hover:bg-emerald-50 transition-colors"><FaWhatsapp className="w-4 h-4 text-green-500" />Hubungi Kami</a>
        </div>
