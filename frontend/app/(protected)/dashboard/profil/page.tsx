  ...
  return (
    <div className="min-h-screen bg-zinc-50">
      <div className="max-w-xl mx-auto px-4 py-10 space-y-6">
        ...
        {/* Avatar + nama */}
        <div className="bg-white border border-zinc-200 rounded-2xl px-6 py-5 flex items-center gap-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Link
            ...
            className="flex items-center gap-3 bg-white border border-zinc-200 rounded-2xl px-4 py-4 hover:border-zinc-300 hover:shadow-sm transition-all group"
          >
            <div className="w-8 h-8 bg-zinc-100 rounded-xl flex items-center justify-center group-hover:bg-zinc-900 transition-colors shrink-0">
          ...
          <Link
            ...
            className="flex items-center gap-3 bg-white border border-zinc-200 rounded-2xl px-4 py-4 hover:border-zinc-300 hover:shadow-sm transition-all group"
          >
            <div className="w-8 h-8 bg-zinc-100 rounded-xl flex items-center justify-center group-hover:bg-emerald-600 transition-colors shrink-0">
