...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-10 text-center">
      ...
      <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight mt-2 mb-2">Halaman Tidak Ditemukan</h1>
      <p className="text-slate-400 text-sm sm:text-base max-w-sm leading-relaxed mb-6">Halaman yang Anda cari tidak tersedia atau telah dipindahkan. Pastikan alamat URL yang Anda masukkan sudah benar.</p>
