...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-10 text-center">
      ...
      <p className="text-slate-400 text-sm sm:text-base max-w-sm leading-relaxed mb-6">Halaman yang Anda cari tidak ada atau sudah dipindahkan. Coba periksa lagi alamat URL yang Anda buka.</p>
