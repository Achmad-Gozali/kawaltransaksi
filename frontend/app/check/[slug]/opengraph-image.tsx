    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={{ fontSize: '11px', fontWeight: 700, color: '#94a3b8', letterSpacing: '0.15em', textTransform: 'uppercase' }}>
            Nomor Terperiksa
          </div>
          <div
            style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            {reports.length > 0 && (
              ...
              >
                <span style={{ fontSize: '24px', fontWeight: 800, color: '#0f172a' }}>{reports.length}</span>
                <span style={{ fontSize: '11px', color: '#94a3b8', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.1em' }}>Laporan</span>
              </div>
            )}
            {totalLoss > 0 && (
              <div
              ...
              >
                <span style={{ fontSize: '24px', fontWeight: 800, color: '#ef4444' }}>{formatLoss(totalLoss)}</span>
                <span style={{ fontSize: '11px', color: '#94a3b8', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.1em' }}>Total Kerugian</span>
              </div>
            )}
          </div>
