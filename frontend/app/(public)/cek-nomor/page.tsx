            ...
            {ewallets.map((wallet) => (
              <Link key={wallet.id} href={`/cek-nomor/cek-ewallet/${wallet.id}`}
                ...
                <div>
                  ...
                  <h3 className="text-xs sm:text-sm font-bold text-slate-900 mb-1">{wallet.name}</h3>
                  <p className="text-[10px] sm:text-[11px] text-slate-400 leading-relaxed hidden sm:block">{wallet.description}</p>
                </div>
