      ...
      <div className="max-w-3xl mx-auto px-4 py-12 sm:py-16">
        ...
        <div className="bg-white border border-zinc-200 rounded-2xl p-6 sm:p-10 space-y-8">
          ...
          <section>
            ...
            <p className="text-sm text-zinc-500 leading-relaxed">
              KawalTransaksi menyajikan informasi berdasarkan laporan komunitas yang telah melalui proses verifikasi otomatis oleh sistem robot kami. Meskipun kami senantiasa berupaya menjaga kualitas dan akurasi data, kami tidak memberikan jaminan mutlak atas kebenaran setiap informasi yang ditampilkan. Setiap keputusan yang Anda ambil berdasarkan informasi di platform ini sepenuhnya menjadi tanggung jawab Anda sendiri.
            </p>
          </section>
