...
export const metadata: Metadata = {
  ...
  description: 'Laporkan nomor HP, rekening bank, e-wallet, atau QRIS terduga pelaku penipuan. Bantu lindungi masyarakat Indonesia dari ancaman penipuan digital.',
