...
const banks = [
  {
    ...
    logo: "/banks/bca.png",
    description:
      "Verifikasi rekening BCA dan identifikasi potensi penipuan sebelum transfer.",
  },
  {
    id: "bri",
    ...
    logo: "/banks/bri.png",
    description:
      "Verifikasi rekening BRI dan identifikasi potensi penipuan sebelum transfer.",
  },
  {
    id: "bni",
    ...
    logo: "/banks/bni.png",
    description:
      "Verifikasi rekening BNI dan identifikasi potensi penipuan sebelum transfer.",
  },
  {
    id: "mandiri",
    name: "Bank Mandiri",
    ...
    description:
      "Verifikasi rekening Mandiri dan identifikasi potensi penipuan sebelum transfer.",
  },
  {
    id: "cimb",
    ...
    logo: "/banks/cimb.png",
    description:
      "Verifikasi rekening CIMB Niaga dan identifikasi potensi penipuan sebelum transfer.",
  },
  {
    id: "bsi",
    ...
    logo: "/banks/bsi.png",
    description:
      "Verifikasi rekening BSI dan identifikasi potensi penipuan sebelum transfer.",
  },
];
...
const articles = [
  ...
  },
  {
    ...
    desc: "KawalTransaksi merupakan platform pengecekan rekening penipu terlengkap. Cek nomor rekening BCA, BRI, BNI, Mandiri, CIMB Niaga, BSI, dan lainnya.",
  },
  {
    title: "Cara Cek Nomor Rekening",
    desc: "Masukkan nomor rekening yang ingin dicek pada kolom pencarian di atas untuk mendapatkan hasil pengecekan.",
  },
  {
    title: "Laporkan Rekening Penipu",
    desc: "Semua laporan yang masuk akan kami tinjau dari kronologis kejadian hingga bukti transfer sebelum dipublikasikan.",
  },
  {
    title: "Sudah Terlanjur Transfer ke Penipu?",
    desc: "Segera hubungi bank Anda untuk memblokir transaksi dan laporkan nomor rekening tersebut ke KawalTransaksi.",
  },
];

// [OK] OPTIMIZED: 3 query &rarr; 1 RPC call
...
export default async function CekRekeningPage() {
  ...
  const stats = [
    ...
    },
    {
      ...
      value:
        totalRekening > 0 ? `${totalRekening.toLocaleString("id-ID")}+` : "0",
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-10 pb-10 sm:pb-24">
            <div className="flex-1 text-center md:text-left w-full">
              ...
              <p className="text-slate-500 text-sm sm:text-base mb-6 sm:mb-12 max-w-xl mx-auto md:mx-0 leading-relaxed">
                Periksa nomor rekening bank tujuan sebelum melakukan transfer
                dana. Kurangi risiko penipuan finansial dengan verifikasi cepat
                berbasis laporan komunitas.
              </p>
              <RekeningSearchForm />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8 items-center text-left">
            <div>
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Layanan verifikasi rekening bank KawalTransaksi membantu Anda
                mengidentifikasi potensi risiko penipuan pada nomor rekening
                tujuan, berdasarkan laporan dan keluhan pengguna yang telah
            ...
            <div className="bg-emerald-50 rounded-xl px-5 sm:px-8 py-5 sm:py-7">
              <p className="text-slate-800 text-sm font-bold leading-relaxed text-center">
                &quot;Sebelum transfer, selalu verifikasi rekening tujuan. Satu
                langkah kecil yang bisa menyelamatkan uang Anda dari tangan
                penipu.&quot;
              </p>
            </div>
          </div>
        ...
        <div className="flex items-end justify-between mb-4 sm:mb-6 border-b border-slate-200 pb-3 sm:pb-4">
          <div>
            ...
            <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-0.5">
              Pilih bank untuk mulai verifikasi
            </p>
          </div>
        </div>
