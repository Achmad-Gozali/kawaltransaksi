...
const articles = [
  { title: "Cek Rekening Penjual Online",        desc: "Jadilah pembeli yang cermat dengan memeriksa apakah seorang penjual berpotensi melakukan penipuan sebelum Anda berbelanja online." },
...
const schema = {
  ...
  "@graph": [
    { "@type": "WebPage", "@id": "https://kawaltransaksi.com/cek-rekening", "url": "https://kawaltransaksi.com/cek-rekening", "name": "Cek Rekening Penipu - KawalTransaksi", "isPartOf": { "@id": "https://kawaltransaksi.com/#website" } },
...
const bankLogoMap: Record<string, string> = { bca: "/banks/bca.png", bni: "/banks/bni.png", bri: "/banks/bri.png", bsi: "/banks/bsi.png", cimb: "/banks/cimb.png", mandiri: "/banks/mandiri.png" };
const ewalletLogoMap: Record<string, string> = { gopay: "/ewallets/gopay.png", dana: "/ewallets/dana.png", ovo: "/ewallets/ovo.png", shopeepay: "/ewallets/shopeepay.png", linkaja: "/ewallets/linkaja.png" };
...
export default async function CekRekeningPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans">
      <SearchHero
        title="Cek Rekening Penipu Online"
        description="Identifikasi apakah seseorang berpotensi melakukan penipuan dengan mengecek nomor rekening bank penjual sebelum berbelanja online."
        hint={<>Contoh: <span className="text-emerald-600 font-medium">1234567890</span></>}
      >
        <RekeningSearchForm />
      </SearchHero>
      ...
      <section className="bg-white pb-10 sm:pb-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 -mt-6 sm:-mt-14 relative z-10">
          <LiveStats
            ...
            blacklistDesc="Rekening bank telah terblacklist pada sistem kami"
            initial={{ total: totalLaporan, verified: totalRekening, totalLoss: Number(totalKerugian) }}
          />
        </div>
      </section>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            ...
            <div className="bg-white border border-slate-200 rounded-lg overflow-hidden divide-y divide-slate-100">
              {(leaderboard as any[]).map((entry, i) => {
                const displayNumber = entry.target_number;
                return (
      ...
      <section className="bg-slate-100 py-8 sm:py-14">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {banks.map((b) => (
              <Link key={b.id} href={`/cek-rekening/${b.id}`} className="group bg-white border border-slate-200 rounded-xl p-4 sm:p-6 hover:border-emerald-400 hover:shadow-md transition-all duration-200 flex flex-col justify-between">
                <div>
