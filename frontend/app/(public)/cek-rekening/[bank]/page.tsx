...
const bankData: Record<string, {
  ...
  bca: {
    ...
    kodeBank: "014", callCenter: "1500888", website: "https://www.bca.co.id",
    websiteLabel: "bca.co.id", helpUrl: "https://www.bca.co.id/id/Tentang-BCA/Hubungi-BCA",
    dbName: "BCA",
  ...
  bri: {
    ...
    kodeBank: "002", callCenter: "1500017", website: "https://www.bri.co.id",
    websiteLabel: "bri.co.id", helpUrl: "https://bri.co.id/web/guest/kontak",
    dbName: "BRI",
  ...
  bni: {
    ...
    kodeBank: "009", callCenter: "1500046", website: "https://www.bni.co.id",
    websiteLabel: "bni.co.id", helpUrl: "https://www.bni.co.id/id-id/beranda/hubungikami",
    dbName: "BNI",
  ...
  mandiri: {
    ...
    kodeBank: "008", callCenter: "14000", website: "https://www.bankmandiri.co.id",
    websiteLabel: "bankmandiri.co.id", helpUrl: "https://www.bankmandiri.co.id/kontak-kami",
    dbName: "Mandiri",
  ...
  cimb: {
    ...
    kodeBank: "022", callCenter: "14041", website: "https://www.cimbniaga.co.id",
    websiteLabel: "cimbniaga.co.id", helpUrl: "https://www.cimbniaga.co.id/id/personal/bantuan",
    dbName: "CIMB",
  ...
  bsi: {
    ...
    kodeBank: "451", callCenter: "14040", website: "https://www.bankbsi.co.id",
    websiteLabel: "bankbsi.co.id", helpUrl: "https://www.bankbsi.co.id/company-info/hubungi-kami",
    dbName: "BSI",
...
export default async function BankDetailPage({ params }: PageProps) {
  ...
  try {
    ...
    if (res.ok) {
      ...
      primaryReports = json.data?.primary ?? [];
      linkedReports  = json.data?.linked  ?? [];
    }
  } catch {}
  ...
  linkedReports.forEach((r: any) => {
    ...
    r.target_numbers.forEach((item: any) => {
      if (
        typeof item === 'object' && item.type === 'bank_account' &&
        item.bank?.toLowerCase() === data.dbName.toLowerCase() && item.number
      ) {
        linkedRows.push({ target_number: item.number, target_name: item.name ?? null, status: r.status, created_at: r.created_at });
      }
    });
  });
  ...
  [...primaryReports, ...linkedRows].forEach((r) => {
  ...
  const structuredData = {
    ...
    about: {
      ...
      name: data.fullName,
      provider: { "@type": "BankOrCreditUnion", name: data.fullName, telephone: data.callCenter, url: data.website },
    },
  };
