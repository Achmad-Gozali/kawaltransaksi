...
import { ArrowLeft, ArrowRight, Phone, Hash, Globe, ShieldCheck } from "lucide-react";
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 uppercase tracking-[0.15em] mt-0.5 font-medium">Verifikasi rekening - {data.name}</p>
                </div>
              </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-2.5 px-0.5">
            <p className="text-[10px] uppercase tracking-[0.15em] text-slate-400 font-medium">Rekening {data.name} dilaporkan</p>
