...
const DEV_USE_CASES = [
  {
    ...
    desc: "Verifikasi nomor rekening dan e-wallet secara otomatis sebelum memproses transfer atau pembayaran.",
  },
  {
    title: "Bot Telegram & WhatsApp",
    desc: "Tambahkan fitur pengecekan nomor langsung ke dalam bot percakapan Anda secara real-time.",
  },
  {
    title: "Platform E-Commerce",
    desc: "Lindungi ekosistem jual beli Anda dengan memvalidasi nomor rekening penjual sebelum pencairan dana.",
  },
  {
    title: "Sistem Verifikasi Pembayaran",
    desc: "Tambahkan lapisan keamanan ekstra pada alur checkout atau konfirmasi pembayaran.",
  },
  {
    title: "Aplikasi Pinjaman Online (P2P Lending)",
    desc: "Perkuat proses KYC dan verifikasi identitas peminjam sebelum pengajuan pinjaman disetujui.",
  },
  {
    title: "Sistem CRM & Customer Service",
    desc: "Bekali agen customer service dengan kemampuan verifikasi nomor secara langsung saat menangani aduan.",
  },
];
...
async function getIsLoggedIn(): Promise<boolean> {
  try {
    ...
    return allCookies.some((c) => c.name.startsWith("sb-") && c.name.endsWith("-auth-token"));
  } catch { return false; }
}
