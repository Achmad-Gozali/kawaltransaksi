...
const sections = [
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p className="pl-4">c. Memproses laporan secara otomatis melalui sistem verifikasi otomatis kami untuk deteksi pola dan penilaian tingkat risiko.</p>
  ...
  {
    title: '3. Perlindungan Data Pelapor',
    content: (
      <div className="space-y-2">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p className="pl-4">c. Untuk keperluan pembuatan artikel edukasi secara otomatis melalui layanan Groq, yang hanya memproses data tren laporan secara agregat — bukan data pribadi pengguna.</p>
      </div>
    ),
  },
  {
  ...
  {
    title: '7. Penggunaan Cookies dan Analitik',
    content: (
      <div className="space-y-2">
