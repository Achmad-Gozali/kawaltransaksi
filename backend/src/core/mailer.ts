    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;background:#fff;">
        ...
        <p style="font-size:14px;color:#64748b;margin:0 0 24px;line-height:1.6;">
          Halo <strong>${name}</strong>, gunakan kode verifikasi berikut untuk mengaktifkan akun KawalTransaksi Anda.
        </p>
        ...
        <p style="font-size:12px;color:#94a3b8;margin:0 0 8px;line-height:1.6;">
          Mohon jangan bagikan kode ini kepada siapa pun, termasuk tim KawalTransaksi.
        </p>
        <p style="font-size:12px;color:#94a3b8;margin:0;line-height:1.6;">
          Jika Anda tidak melakukan pendaftaran ini, mohon abaikan email ini.
        </p>
  ...
  await getResend().emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;background:#fff;">
        ...
        <p style="font-size:14px;color:#64748b;margin:0 0 24px;line-height:1.6;">
          Halo <strong>${name}</strong>, kami menerima permintaan untuk mengatur ulang kata sandi akun KawalTransaksi Anda.
        </p>
        ...
        <p style="font-size:12px;color:#94a3b8;margin:24px 0 0;line-height:1.6;">
          Tautan ini berlaku selama <strong>1 jam</strong>. Jika Anda tidak mengajukan permintaan ini, mohon abaikan email ini.
        </p>
        <hr style="border:none;border-top:1px solid #f1f5f9;margin:24px 0;" />
        <p style="font-size:11px;color:#cbd5e1;margin:0;">© 2026 KawalTransaksi · kawaltransaksi.com</p>
      </div>
  ...
  await getResend().emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;background:#fff;">
        ...
        <p style="font-size:14px;color:#64748b;margin:0 0 24px;line-height:1.6;">
          Akun Anda beserta riwayat laporan tetap aman dan telah kami pindahkan ke sistem baru. Namun, demi alasan keamanan, Anda perlu <strong>membuat kata sandi baru</strong> sebelum dapat masuk kembali.
        </p>
        ...
        <p style="font-size:12px;color:#94a3b8;margin:24px 0 0;line-height:1.6;">
          Klik tombol di atas, masukkan alamat email Anda (<strong>${email}</strong>), lalu ikuti instruksi untuk membuat kata sandi baru.
        </p>
        <hr style="border:none;border-top:1px solid #f1f5f9;margin:24px 0;" />
        <p style="font-size:11px;color:#cbd5e1;margin:0;">© 2026 KawalTransaksi · kawaltransaksi.com</p>
      </div>
